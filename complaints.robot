...
#   ...  tender_complaint
#   [Setup]  Дочекатись синхронізації з майданчиком  ${viewer}
#   Звірити відображення поля author вимоги із ${USERS.users['${provider}'].claim_data.claim.data.author} для користувача ${viewer}
...
#   ...  award_complaint
#   [Setup]  Дочекатись синхронізації з майданчиком  ${viewer}
#   Звірити відображення поля author вимоги про виправлення визначення ${award_index} переможця із ${USERS.users['${provider}'].claim_data.claim.data.author} для користувача ${viewer}
